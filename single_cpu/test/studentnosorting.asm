...
#20173 0150 0184
######################################################################################################################### instr.(H) ####### addr.(H)
      lui     $2, 0x150          # high halfword the student no (last 8 digitals), use your own student no. instead!      # 0                0
      ori     $2, $2, 0x184      # low halfword of the student no (last 8 digitals)                                       # 1                4
